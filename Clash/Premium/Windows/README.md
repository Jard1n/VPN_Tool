...
[Clash for Windows文档](https://doc.clashforwindows.app/quickstart/)   
...
- 点击下载对应版本的 [Clash for Windows汉化文件](https://github.com/BoyceLig/Clash_Chinese_Patch)，然后用它替换掉原来的 **app.asar** 文件。  
- 替换完成之后运行软件即可看到效果。  
